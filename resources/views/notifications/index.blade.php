    ...
    <x-slot name="header">
        <div class="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
            <div>
                ...
                <p class="section-copy mt-2">Review simple database notifications for requests, approvals, completions, and ratings.</p>
            </div>
            ...
            @forelse($notifications as $notification)
                @php
                    ...
                    $targetUrl = match($notification->type) {
                        'request', 'approval', 'rejection', 'completion', 'rating' => $notification->related_id ? route('transactions.show', $notification->related_id) : null,
