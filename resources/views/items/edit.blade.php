    ...
    <x-slot name="header">
        <div class="flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
            <div>
                ...
                <p class="section-copy mt-2">Revise the details below before presenting the updated listing in your capstone demo.</p>
            </div>
    ...
    <div class="page-wrap space-y-6">
        ...
        <div class="glass-card flex flex-col gap-4 p-6 sm:flex-row sm:items-center sm:justify-between">
            <div>
                ...
                <p class="mt-1 text-sm text-slate-300">Only remove the item if it should no longer appear in the demo marketplace.</p>
            </div>
